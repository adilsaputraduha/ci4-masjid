        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb float-right">
                    ...
                    <li class="breadcrumb-item"><a href="#">Uang Keluar</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="col-xl-12">
    <div class="card">
        <div class="card-header">
            ...
            <a href="/uangkeluar/report" class="btn btn-secondary float-right pdf" target="_blank"><i class="icofont icofont-print"></i> Print</a>
        </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title"> Tambah Uang Keluar</h6>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <select name="jenispengeluaran" class="form-control" required>
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <input type="text" class="form-control" placeholder="Masukan Keterangan" id="keterangan" name="keterangan" autocomplete="off">
                    </div>
                    <div class="col-md-12 mb-2">
                        <label>Jumlah *</label>
...
<form id="form_edit">
    ...
    <div class="modal fade" id="updateModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title"> Edit Uang Keluar</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="col-md-12 mb-2">
                        <label>Jenis Uang Keluar *</label>
                        <select name="jenispengeluaran" class="form-control jenispengeluaran" id="jenispengeluaran" required>
                            <?php foreach ($jenispengeluaran as $row) : ?>
                                <option value="<?= $row['idp']; ?>"><?= $row['nama']; ?></option>
                            <?php endforeach; ?>
                        </select>
...
<form id="form_delete">
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title"> Konfirmasi Hapus Uang Keluar</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
